...
<div class="col-md-3">
    <ul class="list-unstyled profile-nav">
        <li>
            <img src="{{asset('assets-template/admin/pages/media/profile/profile-img.png')}}" class="img-responsive"
                 alt=""/>
...
<div class="tab-pane active" id="tab_1_11">
    <div class="portlet-body">
        <table class="table table-striped table-bordered table-advance table-hover">
            ...
            <tr>
                <th>
                    <i class="fa fa-briefcase"></i> Compañia
                </th>
                <th class="hidden-xs">
                    <i class="fa fa-question"></i> Descripcion
                </th>
                <th>
                    <i class="fa fa-bookmark"></i> Montos
                </th>
                <th>
                </th>
            </tr>
            ...
            <ul class="ver-inline-menu tabbable margin-bottom-10">
                ...
                <li>
                    <a data-toggle="tab" href="#tab_2-2">
                        <i class="fa fa-picture-o"></i> Cambiar Avatar </a>
                </li>
                <li>
                ...
                <li>
                    <a data-toggle="tab" href="#tab_4-4">
                        <i class="fa fa-eye"></i> Opciones de Privacidad </a>
                </li>
            </ul>
        </div>
        <div class="col-md-9">
...
<div class="tab-pane" id="tab_1_4">
        ...
        <div class="col-md-12">
            <div class="add-portfolio">
                ...
                <a href="#" class="btn icn-only green">
                    Añadir un Nuevo Projecto <i class="m-icon-swapright m-icon-white"></i>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="row portfolio-block">
        <div class="col-md-5">
            <div class="portfolio-text">
                <img src="{{asset('assets-template/admin/pages/media/profile/logo_metronic.jpg')}}" alt=""/>
    ...
    <div class="row portfolio-block">
        <div class="col-md-5 col-sm-12 portfolio-text">
            <img src="{{asset('assets-template/admin/pages/media/profile/logo_azteca.jpg')}}" alt=""/>
    ...
    <div class="row portfolio-block">
        <div class="col-md-5 portfolio-text">
            <img src="{{asset('assets-template/admin/pages/media/profile/logo_conquer.jpg')}}" alt=""/>
        ...
        <div class="panel panel-default">
            ...
            <div id="accordion1_2" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    squid single-origin coffee nulla assumenda shoreditch et. Anim pariatur cliche reprehenderit, enim
